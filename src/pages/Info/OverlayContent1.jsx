...
const OverlayContent1 = ({ handleButtonClick }) => {
    return (
                ...
                <div>
                    <div className="grid grid-flow-row gap-5">
                        <div className="flex flex-row" >
                            <h1 className="scroll-m-20 font-extrabold text-justify text-purple-300 tracking-widest lg:text-5xl">
                                Hello
                            </h1>
                            <h1 className="scroll-m-20 font-extrabold text-justify tracking-widest lg:text-5xl">
                                , I'm Shailyn.
                            </h1>
                        </div>
                        <div className="flex flex-row" >
                            ...
                            <h1 className="scroll-m-20 font-extrabold text-justify text-purple-300 tracking-widest ml-6 lg:text-5xl">
                                world
                            </h1>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-flow-col mt-10 pr-10">
                        ...
                        <img src={profilepic} alt="pic" className="rounded-lg h-5/6 " />
                    </div>
                </div>
            </div>
...
export default OverlayContent1;
