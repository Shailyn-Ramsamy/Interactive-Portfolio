...
const AnimatedH1 = ({ children, className, currentStage, onClickButton }) => {
    ...
    const handleClick = () => {
        // Set isOpen to true
        setIsOpen(true);
        // Call the onClickButton function
        onClickButton();
    };
...
const renderContent = {
    1: (
        <AnimatedH1 currentStage={1}>
            <div style={{ maxWidth: "700px", margin: "auto", alignItems: "center" }} >
                ...
                <div className="my-6 w-full">
                    <table className="w-full">
                        ...
                        <tr className="m-0 border-t p-0 even:bg-muted">
                            <th className="border px-4 py-2 text-left font-bold [&[align=center]]:text-center [&[align=right]]:text-right text-white">
                                King's Treasury
                            </th>
                            <th className="border px-4 py-2 text-left font-bold [&[align=center]]:text-center [&[align=right]]:text-right text-white">
                                People's happi
                        ...
                        <tbody>
                        <tr className="m-0 border-t p-0 even:bg-muted">
                            <td className="border px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right text-white" >
                                Empty
                            </td>
                            <td className="border px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right text-white">
                                Overflowing
    ...
    3: (
        <AnimatedH1 className="sm-text-xl sm:leading-snug text-center text-white mx5" currentStage={3}>
            <div style={{ maxWidth: "700px", margin: "auto", alignItems: "center" }}>
                <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
                    Contact
                </h1>
    ...
    4: (
        <AnimatedH1 className="sm-text-xl sm:leading-snug text-center text-white mx5" currentStage={4}>
            <div style={{ maxWidth: "700px", margin: "auto", alignItems: "center" }}>
                <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
                    About
                </h1>
